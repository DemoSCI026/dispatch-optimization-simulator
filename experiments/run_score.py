"""Run the score-based greedy baseline."""
...
from src.policies.score_greedy import ScoreGreedyPolicy
from src.simulator.simulator import Simulator



def main() -> None:
    parser = argparse.ArgumentParser(description="Run the score-greedy dispatch baseline.")
    parser.add_argument(
        "--data-dir",
        type=str,
        default=None,
