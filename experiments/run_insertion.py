"""Run the route-insertion heuristic."""
...
from src.policies.route_insertion import RouteInsertionPolicy
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the route-insertion dispatch heuristic.")
    parser.add_argument(
        "--data-dir",
        type=str,
        default=None,
